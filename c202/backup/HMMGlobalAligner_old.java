	...
	*/	
	...
	public void printPosteriorProbs() {
		...
		output.add("COLUMN:"+j+" LETTER:- PROB="+
			   ...
			   " probE: "+probBaseE+" STATE: "+currCell.prevStateToDelete);
	    }
	    else{ 
		...
		output.add("COLUMN:"+j+" LETTER:- PROB="+
			   ...
			   " x,y: " +currCell.xLoc+","+currCell.yLoc+" pMatch: "+currCell.pDelete+
			   " probE: "+probBaseE+" STATE: "+currCell.prevStateToDelete);
	    }
		...
		if(whichTB == HMM.MATCH){
			...
			output.add("COLUMN:"+i+" LETTER:"+sequence.charAt(i)+" PROB="+ 
				   MathUtil.round( Math.exp( currCell.matchTraceBack.pMatch - probBaseE ) * 100 ) +
				   " x,y: " +currCell.xLoc+","+currCell.yLoc+" pTBMatch: "+currCell.matchTraceBack.pMatch+
				   " probE: "+probBaseE);
		    }
		    if(currCell.prevStateToMatch == HMM.DELETION){
			output.add("COLUMN:"+i+" LETTER:- PROB="+ 
				   MathUtil.round( Math.exp( currCell.matchTraceBack.pDelete - probBaseE ) * 100 ) +
				   " x,y: " +currCell.xLoc+","+currCell.yLoc+" pTBDel: "+currCell.matchTraceBack.pDelete+
				   " probE: "+probBaseE); 
		    }
		    if(matrix[i][j].matchTraceBack != null &&
		       matrix[i][j].matchTraceBack.prevStateToMatch != HMM.BEGIN &&
		       matrix[i][j].matchTraceBack.prevStateToMatch != 0){
			Logger.debugln("\t_____iterator____");
			Logger.debugln("\tcurr x,y: "+currCell.xLoc+","+currCell.yLoc+
				       " matchTB: "+matrix[i][j].matchTraceBack.xLoc+","+matrix[i][j].matchTraceBack.yLoc+
				       " stateTB: "+matrix[i][j].matchTraceBack.prevStateToMatch);
		...
		if(whichTB == HMM.DELETION){
			...
			Logger.debugln("\tCOLUMN:"+j+" LETTER:"+sequence.charAt(j-1)+" PROB="+ 
				   MathUtil.round( Math.exp( currCell.deleteTraceBack.pMatch - probBaseE ) * 100 ) + 
				   " x,y: " +currCell.xLoc+","+currCell.yLoc+" pM: "+currCell.pMatch+
				   " probE: "+probBaseE+" STATE: "+currCell.prevStateToDelete);
		    ...
		    if(currCell.prevStateToDelete == HMM.DELETION){
			Logger.debugln("\tCOLUMN:"+j+" LETTER:- PROB="+ 
				   MathUtil.round( Math.exp( currCell.deleteTraceBack.pDelete - probBaseE ) * 100 ) +
				   " x,y: " +currCell.xLoc+","+currCell.yLoc+" pMatch: "+currCell.pDelete+
				   " probE: "+probBaseE+" STATE: "+currCell.prevStateToDelete);
			output.add("COLUMN:"+j+" LETTER:- PROB="+ 
				   MathUtil.round( Math.exp( currCell.deleteTraceBack.pDelete - probBaseE ) * 100 ) +
		    ...
		    if(matrix[i][j].deleteTraceBack != null &&
		       matrix[i][j].deleteTraceBack.prevStateToDelete != HMM.BEGIN &&
		       matrix[i][j].deleteTraceBack.prevStateToDelete != 0){
			Logger.debugln("\t_____iterator____");
			Logger.debugln("\tcurr x,y: "+currCell.xLoc+","+currCell.yLoc+
				       " delTB: "+matrix[i][j].deleteTraceBack.xLoc+","+matrix[i][j].deleteTraceBack.yLoc+
				       " stateTB: "+matrix[i][j].deleteTraceBack.prevStateToDelete);
			Logger.debugln("\t_________________");
